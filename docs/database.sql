...
insert  into `t_category`(`id`,`codename`,`fk_parent`,`sort`,`path`,`image`,`status`,`is_container`) values (1,'art_glass',NULL,1,'1/',NULL,1,0),(2,'glassware',NULL,2,'2/',NULL,1,0),(3,'wholesale',NULL,3,'3/',NULL,1,1),(4,'child1',3,1,'3/1/',NULL,1,0),(5,'child2',3,2,'3/2/',NULL,1,0);
...
insert  into `t_category_language`(`id`,`fk_category`,`language`,`name`,`description`) values (1,1,'EN-US','Art glass',NULL),(2,1,'VN-VI','Thủy tinh nghệ thuật','Mô tả thủy tinh nghệ thuật'),(3,2,'EN-US','Glassware','Glassware description'),(4,2,'VN-VI','Pha lê gia dụng','Mô tả pha lê gia dụng'),(5,3,'EN-US','Computer',NULL),(6,3,'VN-VI','Máy tính',NULL),(7,4,'EN-US','child1',NULL),(8,4,'VN-VI','child1',NULL),(9,5,'EN-US','child2',NULL),(10,5,'VN-VI','child2',NULL);
...
insert  into `t_seller`(`id`,`name`,`logo`,`phoneno`,`email`,`website`,`status`,`status_date`,`status_reason`,`fk_manager`) values (1,'Samsung',NULL,NULL,NULL,NULL,1,NULL,NULL,1);
...
insert  into `t_wishlist`(`id`,`fk_customer`,`name`,`remind_date`,`note`,`date_created`) values (10,42,'main',NULL,NULL,'2014-04-08 23:21:45');
...
insert  into `t_wishlist_detail`(`id`,`fk_wishlist`,`type`,`note`,`fk_product`,`status`) values (9,6,NULL,NULL,1,1),(10,10,NULL,NULL,1,1);
