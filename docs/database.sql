...
insert  into `t_category_language`(`id`,`fk_category`,`language`,`name`,`description`) values (1,1,'EN-US','Art glass',NULL),(2,1,'VN-VI','Thủy tinh nghệ thuật','Mô tả thủy tinh nghệ thuật'),(3,2,'EN-US','Glassware','Glassware description'),(4,2,'VN-VI','Pha lê gia dụng','Mô tả pha lê gia dụng');
...
CREATE TABLE `t_file` (
  ...
  `real_path` text COLLATE utf8_unicode_ci,
