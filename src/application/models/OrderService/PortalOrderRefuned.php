...
class PortalOrderRefuned
{
    ...
    protected  $contact;
    protected  $user;
    function __construct($user,$orderId,$products,$contact,$otherCosts,$comment){
        $this->user = $user;
    ...
    function process($orderId){
        ...
        $portalInvoice->invoice_type = DatabaseFixedValue::INVOICE_TYPE_OUTPUT;
