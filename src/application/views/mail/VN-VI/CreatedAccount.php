...
<br/>
Chúc mừng bạn đã tạo tài khoản thành công tại Sfriendly. Sau đây là thông tin về tài khoản của bạn:<br/>
&nbsp;&nbsp;&nbsp;&nbsp;Tài khoản đăng nhập: <?php echo $user->account;?><br/>
&nbsp;&nbsp;&nbsp;&nbsp;Tên hiển thị: <?php echo $user->full_name;?><br/>
&nbsp;&nbsp;&nbsp;&nbsp;Email: <?php echo $user->account;?><br/>
&nbsp;&nbsp;&nbsp;&nbsp;SĐT: <?php echo $user->phone;?><br/>
<br/>
Bạn đã thể dùng tài khoản này để đăng nhập và sử dụng các dịch vụ của Sfriendly.<br/>
Bấm vào <a href="http://www.sfriendly.com">[đây]</a> để tiếp tục shopping tại Sfriendly.
<br/>
<br/>
