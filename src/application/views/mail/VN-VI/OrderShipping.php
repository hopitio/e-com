...
<p style="padding:0px; margin:0px;" >Đơn hàng của bạn đã được đóng gói xong và sẽ được giao cho bạn trong trước <?php echo $endDate;?>. Nhân viên giao hàng có thể liên lạc với bạn trước khi đi giao. Xin lưu ý là kể từ lúc này bạn không thể thay đổi đơn hàng. Đây là thông tin đơn hàng của bạn :</p>
...
<p style="padding:0px; margin:0px;" >Ngày dự kiến giao hàng: <?php echo $endDate;?> </p>
