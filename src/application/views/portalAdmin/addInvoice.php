<div class="lynx_portalAdminContainer lynx_staticWidth" ng-controller="PortalAdminInvoiceController">
    ...
    <div class="lynx_portalAdminContent">
        ...
        <div class="lynx_row">
            ...
            <span class="lynx_fieldValue"><input type="text" ng-model="invoice.id"/></span>
            <span class="lynx_fieldName">Create by : </span>
            <span class="lynx_fieldValue"><input type="text" ng-model="invoice.created_user"/></span>
            <span class="lynx_fieldName">Order : </span>
            <span class="lynx_fieldValue"><input type="text" ng-model="invoice.fk_order"/></span>
            <span class="lynx_fieldName">Loại hóa đơn : </span>
            <span class="lynx_fieldValue"><input type="text" ng-model="invoice.invoice_type"/></span>
        </div>
        <div class="lynx_row">
            <span class="lynx_fieldValue">Ngày thanh toán : <input type="text" ng-model="invoice.paid_date"/></span>
            <span class="lynx_fieldValue">Ngày hủy : <input type="text" ng-model="invoice.cancelled_date"/></span>
            <span class="lynx_fieldValue">Ngày hủy (Admin) : <input type="text" ng-model="invoice.rejected_date"/></span>
        </div>
        <div class="lynx_row">
            <span class="lynx_fieldValue">Mã thanh toán : <input type="text" ng-model="invoice.payment_id"/></span>
            <span class="lynx_fieldValue">Phương thức thanh toán : <input type="text" ng-model="invoice.payment_method"/></span>
            <span class="lynx_fieldValue">Loại tiền thanh toán : <input type="text" ng-model="invoice.payment_currency"/></span>
        </div>
        <div class="lynx_row">
            <span class="lynx_fieldName">Comment</span>
            <span class="lynx_fieldValue"><textarea rows="" cols="" ng-model="invoice.comment"></textarea></span>
        </div>
