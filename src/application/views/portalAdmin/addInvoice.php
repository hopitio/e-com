...
<section class="content" ng-controller="PortalAdminAddInvoiceController">
...
<form name="refunedFrm" novalidate>
    <div class="col-md-4">
        <div class="box box-danger">
            ...
            <div class="box-body ">
                <span style="font-weight: bold;">Loại hóa đơn : </span> 
                <select class="form-control" ng-model="invoiceType" ng-options="it.name for it in invoiceTypes"  id=""></select> 
                <br/>
                <span style="font-weight: bold;">Ngày thanh toán : </span> 
                <input  id="paied-date" class="form-control" type="text" class="form-control" ng-model="paiedDate" data-inputmask="'alias': 'dd/mm/yyyy'"/>
                <br/>
                <span style="font-weight: bold;">Hình thức thanh toán : </span> 
                <select  class="form-control" ng-model="paymentType" ng-options="pt.name for pt in paymentTypes"></select> 
                <br/>
                <div ng-show="paymentType == paymentTypes[0]">
                    <span style="font-weight: bold;">Mã thanh toán : </span> 
                    <input id="nlcode" class="form-control" type="text" class="form-control" ng-model="NLCode"/>
                </div>
            </div>
        </div>
