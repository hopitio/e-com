                <div class="lynx_row-fluid">
                                <div class="lynx_span4">
                                    <h4><i class="lynx_fa lynx_fa-cog"></i> Bảo mật </h4>
                                    <a href="/portal/change_password">Thay đổi mật khẩu </a><br>
                                    <a href="/portal/change_question">Thay đổi câu hỏi bí mật</a><br>
                                    <a href="#">Thay đổi mail thông báo</a><br/>
                                    <br/>
                                </div>
                                
                                <div class="lynx_span4">
                                    <h4><i class="lynx_fa lynx_fa-user"></i> Thông tin tài khoản</h4>
                                    <a href="/portal/change_user_information">Thay đổi thông tin cá nhân </a><br>
                                    <a href="/portal/contacts">Thêm địa chỉ giao hàng</a><br>
                                ...
                                <div class="lynx_span4">
                                    <h4><i class="lynx_fa lynx_fa-user"></i> Thông tin giao dịch và mua hàng</h4>
