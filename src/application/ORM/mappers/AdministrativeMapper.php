...
class AdministrativeMapper extends MapperAbstract
{

    const TABLE = 't_administrative_unit';

    function __construct($domain = 'AdministrativeDomain')
    {
    ...
    {
        $this->_query->where('unitlevel=?', __FUNCTION__);
